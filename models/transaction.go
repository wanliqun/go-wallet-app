...
type Transaction struct {
	...
	Type           TransactionType `gorm:"type:enum('deposit', 'withdraw', 'transfer_from', 'transfer_to');not null;index:idx_user_type_timestamp_id,priority:2" json:"type"`
	...
	Timestamp      time.Time       `gorm:"default:current_timestamp;index:idx_user_type_timestamp_id,priority:3;index:idx_user_timestamp_id,priority:2" json:"timestamp"`
